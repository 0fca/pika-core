...
We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of [Privacy Policy Generator](https://www.termsfeed.com/privacy-policy-generator/).
...
*   **To improve** abilities of Website e.g. analyze data using Machine Learning algorithms to improve search accuracy or to add other functionalities.
...
Your Personal Data is **not** used to any kind of business transactions nor will be transferred to any other service provider than Us. 
