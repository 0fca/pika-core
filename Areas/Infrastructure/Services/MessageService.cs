...
namespace PikaCore.Areas.Infrastructure.Services
{
    public class MessageService : IMessageService
    {
        ...
        {
            var messages = _messageContext.Messages.AsQueryable();
        ...
        {
            var visibleMessagesList = await _messageContext.Messages.Where(m => m.IsVisible).ToListAsync();
        ...
        {
            return (await _messageContext.Messages.FindAsync(id, true)).RelatedIssues;
        }
