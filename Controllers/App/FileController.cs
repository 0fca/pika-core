    ...
    public class FileController : Controller
    {
        ...
        public IActionResult Create(string parent, string name) {
            ...
            catch (Exception e)
            {
                ...
                TempData["returnMessage"] = "Couldn't create directory.";
                return RedirectToAction(nameof(Index));
            }
        }
        ...
        public IActionResult DeleteConfirmation(string path){
            ...
            try{
                ...
                _loggerService.LogToFileAsync(LogLevel.Error, HttpContext.Connection.RemoteIpAddress.ToString(), "Couldn't delete directory because of " + e.Message);
                TempData["returnMessage"] = "Couldn't delete directory.";
                return RedirectToAction(nameof(Index));
            }
        }
